          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$distributor->nama_distributor}} -
                <a href="/distributor/{{$distributor->id_distributor}}">{{$distributor->id_distributor}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Alamat : </b>{{$distributor -> alamat}}</p>
              <p><b>Telepon : </b>{{$distributor -> telepon}}</p>
              <span class="pull-right text-muted">
              Created At - {{$distributor->created_at}}</span>
