...
@endif
    <div class="form-group">
        ...
        <input type="text" name="nama_distributor" placeholder="Nama Distributor" class="form-control" value="{{$distributor->nama_distributor}}">
    </div>
    <div class="form-group">
        <label>Alamat</label>
        <input type="text" name="alamat" placeholder="Alamat" class="form-control" value="{{$distributor->alamat}}">
    </div>
    <div class="form-group">
        <label>Telepon</label>
        <input type="text" name="telepon" placeholder="telepon" class="form-control" value="{{$distributor->telepon}}">
    </div>
