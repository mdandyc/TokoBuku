...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/distributor/search" method="get" class="sidebar-form">
      ...
      <li class=""><a href="/dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span>
        ...
        <li class="active">
          <a href="/distributor"><i class="fa fa-user-circle"></i> <span>Distributor</span><span class="pull-right-container">
                <i class="fa fa-angle-right pull-right"></i>
           </span> 
          </a>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/distributor/create">Input</a></small>
      </h1>
    </section>
    ...
    @foreach ($distributor as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$data->nama_distributor}} -
                <a href="/distributor/{{$data->id_distributor}}">{{$data->id_distributor}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              <form action="/distributor/{{$data->id_distributor}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/distributor/{{$data->id_distributor}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$distributor->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
