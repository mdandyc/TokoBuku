...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach($buku as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$data->judul}} -
                <a href="/buku/{{$data->id_buku}}">{{$data->id_buku}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              <p><b>Harga Pokok : </b>{{$data -> harga_pokok}}</p>
              <p><b>Harga Jual : </b>{{$data -> harga_jual}}</p>
              <p><b>PPN : </b>{{$data -> ppn}}</p>
              <p><b>Diskon : </b>{{$data -> diskon}}</p>
              @if (Auth::user()->role == 'admin')
        
            
              <form action="/buku/{{$data->id_buku}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/buku/{{$data->id_buku}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$buku->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
