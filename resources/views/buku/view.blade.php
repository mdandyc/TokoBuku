          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$buku->judul}} -
                <a href="/buku/{{$buku->id_buku}}">{{$buku->id_buku}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              <p><b>Harga Pokok : </b>{{$buku -> harga_pokok}}</p>
              <p><b>Harga Jual : </b>{{$buku -> harga_jual}}</p>
              <p><b>PPN : </b>{{$buku -> ppn}}</p>
              <p><b>Diskon : </b>{{$buku -> diskon}}</p>
              
              <span class="pull-right text-muted">
              Created At - {{$buku->created_at}}</span>
