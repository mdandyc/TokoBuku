...
@endif
    <div class="form-group">
        ...
        <select name="distributor_id" class="form-control">
            @foreach ($distributor as $data)
                <option value="{{$data->id_distributor}}"
                @if ($pasok->distributor_id == $data->id_distributor)
                    selected
                @endif
                >{{$data->nama_distributor}}</option>
            @endforeach
        </select>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label>jumlah</label>
        <input type="text" name="jumlah" placeholder="jumlah" class="form-control" value="{{$pasok->jumlah}}">
    </div>
    <div class="form-group">
        <label>tanggal</label>
        <input type="text" name="tanggal" placeholder="tanggal" class="form-control" value="{{$pasok->tanggal}}">
    </div>
