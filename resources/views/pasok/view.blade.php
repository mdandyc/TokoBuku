          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <a href="/pasok/{{$pasok->id_pasok}}">{{$pasok->id_pasok}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>nama_distributor : </b>{{$pasok->distributor->nama_distributor}}</p>
              <p><b>judul : </b>{{$pasok->buku->judul}}</p>
              <p><b>jumlah : </b>{{$pasok -> jumlah}}</p>
              <p><b>tanggal : </b>{{$pasok -> tanggal}}</p>

              <form action="/pasok/{{$pasok->id_pasok}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/pasok/{{$pasok->id_pasok}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
              <button type="submit" class="btn btn-default btn-xs btn-danger" value="Delete"><i class="fa fa-times"></i>Delete</button>
              </form>
              <span class="pull-right text-muted">
              Created At - {{$pasok->created_at}}</span>
