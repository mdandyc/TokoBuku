          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">ID Penjualan -
                <a href="/penjualan/{{$penjualan->id_penjualan}}">{{$penjualan->id_penjualan}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>judul : </b>{{$penjualan->buku->judul}}</p>
              <p><b>nama : </b>{{$penjualan->kasir->nama}}</p>
              <p><b>jumlah : </b>{{$penjualan->jumlah}}</p>
              <p><b>total : </b>{{$penjualan->total}}</p>
              <p><b>tanggal : </b>{{$penjualan->tanggal}}</p>

              <form action="/penjualan/{{$penjualan->id_penjualan}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/penjualan/{{$penjualan->id_penjualan}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
              <button type="submit" class="btn btn-default btn-xs btn-danger" value="Delete"><i class="fa fa-times"></i>Delete</button>
              </form>
              <span class="pull-right text-muted">
              Created At - {{$penjualan->created_at}}</span>
