...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach ($penjualan as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <a href="/penjualan/{{$data->id_penjualan}}">{{$data->id_penjualan}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              <p><b>nama : </b>{{$data->kasir->nama}}</p>
              <p><b>jumlah : </b>{{$data->jumlah}}</p>
              <p><b>total : </b>{{$data->total}}</p>
              <p><b>tanggal : </b>{{$data->tanggal}}</p>

              <form action="/penjualan/{{$data->id_penjualan}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/penjualan/{{$data->id_penjualan}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$penjualan->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
