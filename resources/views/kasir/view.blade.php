          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$kasir->nama}} -
                <a href="/kasir/{{$kasir->id_kasir}}">{{$kasir->id_kasir}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>alamat : </b>{{$kasir -> alamat}}</p>
              <p><b>telepon : </b>{{$kasir -> telepon}}</p>
              <p><b>status : </b>{{$kasir -> status}}</p>

              <span class="pull-right text-muted">
              Created At - {{$kasir->created_at}}</span>
