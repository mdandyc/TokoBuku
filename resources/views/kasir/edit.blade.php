...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/kasir/search" method="get" class="sidebar-form">
      ...
      <li class=""><a href="/dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span>
        ...
        <li class="active"><a href="/kasir"><i class="fa fa-user"></i> <span>Kasir</span><span class="pull-right-container">
                <i class="fa fa-angle-right pull-right"></i>
           </span> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/kasir/create">Input</a></small>
      </h1>
    </section>
...
@endif
    <div class="form-group">
        <label>Nama</label>
        <input type="text" name="nama" placeholder="Nama" class="form-control" value="{{$kasir->nama}}">
    </div>
    <div class="form-group">
        <label>Alamat</label>
        <input type="text" name="alamat" placeholder="Alamat" class="form-control" value="{{$kasir->alamat}}">
    </div>
    <div class="form-group">
        <label>Telepon</label>
        <input type="text" name="telepon" placeholder="telepon" class="form-control" value="{{$kasir->telepon}}">
    </div>
    <div class="form-group">
        <label>Status</label>
        <input type="text" name="status" placeholder="Status" class="form-control" value="{{$kasir->status}}">
    </div>
