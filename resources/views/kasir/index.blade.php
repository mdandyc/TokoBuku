...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    @foreach ($kasir as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">{{$data->nama}} -
                <a href="/kasir/{{$data->id_kasir}}">{{$data->id_kasir}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              <form action="/kasir/{{$data->id_kasir}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/kasir/{{$data->id_kasir}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$kasir->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
